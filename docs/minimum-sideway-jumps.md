...
description: Problem Description and Solution for Minimum Sideway Jumps
sidebar_label: 1824. Minimum Sideway Jumps
sidebar_position: 1824
---

# [1824. Minimum Sideway Jumps](https://leetcode.com/problems/minimum-sideway-jumps/)

```py title=minimum-sideway-jumps.py
class Solution:
