...
description: Problem Description and Solution for Generate Random Point in a Circle
sidebar_label: 478. Generate Random Point in a Circle
sidebar_position: 478
---

# [478. Generate Random Point in a Circle](https://leetcode.com/problems/generate-random-point-in-a-circle/)

```py title=generate-random-point-in-a-circle.py
import random
