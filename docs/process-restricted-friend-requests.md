...
description: Problem Description and Solution for Process Restricted Friend Requests
sidebar_label: 2076. Process Restricted Friend Requests
...
```py title=process-restricted-friend-requests.py
class DSU:
    def __init__(self, n):
        self.p = list(range(n))
