...
description: Problem Description and Solution for Shortest Path in a Grid with Obstacles Elimination
sidebar_label: 1293. Shortest Path in a Grid with Obstacles Elimination
sidebar_position: 1293
---

# [1293. Shortest Path in a Grid with Obstacles Elimination](https://leetcode.com/problems/shortest-path-in-a-grid-with-obstacles-elimination/)

```py title=shortest-path-in-a-grid-with-obstacles-elimination.py
class Solution:
