...
description: Problem Description and Solution for Longest Word in Dictionary
sidebar_label: 720. Longest Word in Dictionary
sidebar_position: 720
---

# [720. Longest Word in Dictionary](https://leetcode.com/problems/longest-word-in-dictionary/)

```py title=longest-word-in-dictionary.py
class TrieNode:
    def __init__(self):
        self.mp = [None] * 26
        self.end = False
