...
description: Problem Description and Solution for Minimum Score After Removals on a Tree
sidebar_label: 2322. Minimum Score After Removals on a Tree
sidebar_position: 2322
---

# [2322. Minimum Score After Removals on a Tree](https://leetcode.com/problems/minimum-score-after-removals-on-a-tree/)

```py title=minimum-score-after-removals-on-a-tree.py
class Solution:
