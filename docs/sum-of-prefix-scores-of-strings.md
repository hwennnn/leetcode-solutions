...
description: Problem Description and Solution for Sum of Prefix Scores of Strings
sidebar_label: 2416. Sum of Prefix Scores of Strings
sidebar_position: 2416
---

# [2416. Sum of Prefix Scores of Strings](https://leetcode.com/problems/sum-of-prefix-scores-of-strings/)

```py title=sum-of-prefix-scores-of-strings.py
# ----------------------------------- Trie -----------------------------------
class Trie:
