...
description: Problem Description and Solution for K Highest Ranked Items Within a Price Range
sidebar_label: 2146. K Highest Ranked Items Within a Price Range
...
```py title=k-highest-ranked-items-within-a-price-range.py
class Solution:
