...
description: Problem Description and Solution for The Latest Time to Catch a Bus
sidebar_label: 2332. The Latest Time to Catch a Bus
sidebar_position: 2332
---

# [2332. The Latest Time to Catch a Bus](https://leetcode.com/problems/the-latest-time-to-catch-a-bus/)

```py title=the-latest-time-to-catch-a-bus.py
class Solution:
