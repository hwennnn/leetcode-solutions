...
description: Problem Description and Solution for Critical Connections in a Network
sidebar_label: 1192. Critical Connections in a Network
sidebar_position: 1192
---

# [1192. Critical Connections in a Network](https://leetcode.com/problems/critical-connections-in-a-network/)

```py title=critical-connections-in-a-network.py
class Solution:
