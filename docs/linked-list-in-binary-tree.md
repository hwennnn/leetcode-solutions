...
description: Problem Description and Solution for Linked List in Binary Tree
sidebar_label: 1367. Linked List in Binary Tree
sidebar_position: 1367
---

# [1367. Linked List in Binary Tree](https://leetcode.com/problems/linked-list-in-binary-tree/)

```py title=linked-list-in-binary-tree.py
