...
description: Problem Description and Solution for Number of Pairs Satisfying Inequality
sidebar_label: 2426. Number of Pairs Satisfying Inequality
sidebar_position: 2426
---

# [2426. Number of Pairs Satisfying Inequality](https://leetcode.com/problems/number-of-pairs-satisfying-inequality/)

```py title=number-of-pairs-satisfying-inequality.py
