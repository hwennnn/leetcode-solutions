...
description: Problem Description and Solution for Minimum Falling Path Sum
sidebar_label: 931. Minimum Falling Path Sum
sidebar_position: 931
---

# [931. Minimum Falling Path Sum](https://leetcode.com/problems/minimum-falling-path-sum/)

```py title=minimum-falling-path-sum.py
class Solution:
