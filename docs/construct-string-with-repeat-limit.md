...
description: Problem Description and Solution for Construct String With Repeat Limit
sidebar_label: 2182. Construct String With Repeat Limit
...
```py title=construct-string-with-repeat-limit.py
class Solution:
