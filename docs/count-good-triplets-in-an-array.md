...
description: Problem Description and Solution for Count Good Triplets in an Array
sidebar_label: 2179. Count Good Triplets in an Array
sidebar_position: 2179
---

# [2179. Count Good Triplets in an Array](https://leetcode.com/problems/count-good-triplets-in-an-array/)

```py title=count-good-triplets-in-an-array.py
