...
description: Problem Description and Solution for Maximum Score Of Spliced Array
sidebar_label: 2321. Maximum Score Of Spliced Array
sidebar_position: 2321
---

# [2321. Maximum Score Of Spliced Array](https://leetcode.com/problems/maximum-score-of-spliced-array/)

```py title=maximum-score-of-spliced-array.py
class Solution:
...
```cpp title=maximum-score-of-spliced-array.cpp
