...
description: Problem Description and Solution for Finding MK Average
sidebar_label: 1825. Finding MK Average
sidebar_position: 1825
---

# [1825. Finding MK Average](https://leetcode.com/problems/finding-mk-average/)

```py title=finding-mk-average.py
