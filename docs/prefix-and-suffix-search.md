...
description: Problem Description and Solution for Prefix and Suffix Search
sidebar_label: 745. Prefix and Suffix Search
sidebar_position: 745
---

# [745. Prefix and Suffix Search](https://leetcode.com/problems/prefix-and-suffix-search/)

```py title=prefix-and-suffix-search.py
class WordFilter:
