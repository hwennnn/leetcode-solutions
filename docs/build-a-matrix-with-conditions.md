...
description: Problem Description and Solution for Build a Matrix With Conditions
sidebar_label: 2392. Build a Matrix With Conditions
sidebar_position: 2392
---

# [2392. Build a Matrix With Conditions](https://leetcode.com/problems/build-a-matrix-with-conditions/)

```py title=build-a-matrix-with-conditions.py
class Solution:
