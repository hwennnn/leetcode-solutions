...
description: Problem Description and Solution for Find Eventual Safe States
sidebar_label: 802. Find Eventual Safe States
sidebar_position: 802
---

# [802. Find Eventual Safe States](https://leetcode.com/problems/find-eventual-safe-states/)

```py title=find-eventual-safe-states.py
class Solution:
