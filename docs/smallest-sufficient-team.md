...
description: Problem Description and Solution for Smallest Sufficient Team
sidebar_label: 1125. Smallest Sufficient Team
sidebar_position: 1125
---

# [1125. Smallest Sufficient Team](https://leetcode.com/problems/smallest-sufficient-team/)

```py title=smallest-sufficient-team.py
class Solution:
