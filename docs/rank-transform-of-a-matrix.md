...
description: Problem Description and Solution for Rank Transform of a Matrix
sidebar_label: 1632. Rank Transform of a Matrix
sidebar_position: 1632
---

# [1632. Rank Transform of a Matrix](https://leetcode.com/problems/rank-transform-of-a-matrix/)

```py title=rank-transform-of-a-matrix.py
class DSU:
