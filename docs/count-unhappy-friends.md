...
description: Problem Description and Solution for Count Unhappy Friends
sidebar_label: 1583. Count Unhappy Friends
sidebar_position: 1583
---

# [1583. Count Unhappy Friends](https://leetcode.com/problems/count-unhappy-friends/)

```py title=count-unhappy-friends.py
class Solution:
