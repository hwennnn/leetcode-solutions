...
description: Problem Description and Solution for Maximum Segment Sum After Removals
sidebar_label: 2382. Maximum Segment Sum After Removals
...
```py title=maximum-segment-sum-after-removals.py
class UnionFind:
    def __init__(self):
        self._parent = {}
        self.segmentSum = {}
