...
description: Problem Description and Solution for Find All People With Secret
sidebar_label: 2092. Find All People With Secret
sidebar_position: 2092
---

# [2092. Find All People With Secret](https://leetcode.com/problems/find-all-people-with-secret/)

```py title=find-all-people-with-secret.py
class DSU:
    def __init__(self, n):
