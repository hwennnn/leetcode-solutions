...
description: Problem Description and Solution for Insert Delete GetRandom O(1) - Duplicates allowed
sidebar_label: 381. Insert Delete GetRandom O(1) - Duplicates allowed
sidebar_position: 381
---

# [381. Insert Delete GetRandom O(1) - Duplicates allowed](https://leetcode.com/problems/insert-delete-getrandom-o1-duplicates-allowed/)

```py title=insert-delete-getrandom-o1-duplicates-allowed.py
