...
description: Problem Description and Solution for Construct Smallest Number From DI String
sidebar_label: 2375. Construct Smallest Number From DI String
...
```py title=construct-smallest-number-from-di-string.py
class Solution:
