...
description: Problem Description and Solution for Pseudo-Palindromic Paths in a Binary Tree
sidebar_label: 1457. Pseudo-Palindromic Paths in a Binary Tree
sidebar_position: 1457
---

# [1457. Pseudo-Palindromic Paths in a Binary Tree](https://leetcode.com/problems/pseudo-palindromic-paths-in-a-binary-tree/)

```py title=pseudo-palindromic-paths-in-a-binary-tree.py
