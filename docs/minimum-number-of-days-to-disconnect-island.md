...
description: Problem Description and Solution for Minimum Number of Days to Disconnect Island
sidebar_label: 1568. Minimum Number of Days to Disconnect Island
...
```py title=minimum-number-of-days-to-disconnect-island.py
import copy
class Solution:
