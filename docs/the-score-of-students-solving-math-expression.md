...
description: Problem Description and Solution for The Score of Students Solving Math Expression
sidebar_label: 2019. The Score of Students Solving Math Expression
...
```py title=the-score-of-students-solving-math-expression.py
class Solution:
