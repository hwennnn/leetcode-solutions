...
description: Problem Description and Solution for Maximum Employees to Be Invited to a Meeting
sidebar_label: 2127. Maximum Employees to Be Invited to a Meeting
...
```py title=maximum-employees-to-be-invited-to-a-meeting.py
class Solution:
