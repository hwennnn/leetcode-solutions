...
description: Problem Description and Solution for Count Numbers with Unique Digits
sidebar_label: 357. Count Numbers with Unique Digits
sidebar_position: 357
---

# [357. Count Numbers with Unique Digits](https://leetcode.com/problems/count-numbers-with-unique-digits/)

```py title=count-numbers-with-unique-digits.py
class Solution:
