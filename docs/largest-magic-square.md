...
description: Problem Description and Solution for Largest Magic Square
sidebar_label: 1895. Largest Magic Square
sidebar_position: 1895
---

# [1895. Largest Magic Square](https://leetcode.com/problems/largest-magic-square/)

```py title=largest-magic-square.py
class Solution:
