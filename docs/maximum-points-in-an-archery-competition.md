...
description: Problem Description and Solution for Maximum Points in an Archery Competition
sidebar_label: 2212. Maximum Points in an Archery Competition
...
```py title=maximum-points-in-an-archery-competition.py
class Solution:
