...
description: Problem Description and Solution for Find the Shortest Superstring
sidebar_label: 943. Find the Shortest Superstring
sidebar_position: 943
---

# [943. Find the Shortest Superstring](https://leetcode.com/problems/find-the-shortest-superstring/)

```py title=find-the-shortest-superstring.py
class Solution:
