...
description: Problem Description and Solution for Recover Binary Search Tree
sidebar_label: 99. Recover Binary Search Tree
sidebar_position: 99
---

# [99. Recover Binary Search Tree](https://leetcode.com/problems/recover-binary-search-tree/)

```py title=recover-binary-search-tree.py
