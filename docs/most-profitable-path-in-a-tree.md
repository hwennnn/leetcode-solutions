...
description: Problem Description and Solution for Most Profitable Path in a Tree
sidebar_label: 2467. Most Profitable Path in a Tree
sidebar_position: 2467
---

# [2467. Most Profitable Path in a Tree](https://leetcode.com/problems/most-profitable-path-in-a-tree/)

```py title=most-profitable-path-in-a-tree.py
class Solution:
