...
description: Problem Description and Solution for Number of Flowers in Full Bloom
sidebar_label: 2251. Number of Flowers in Full Bloom
sidebar_position: 2251
---

# [2251. Number of Flowers in Full Bloom](https://leetcode.com/problems/number-of-flowers-in-full-bloom/)

```py title=number-of-flowers-in-full-bloom.py
class Solution:
