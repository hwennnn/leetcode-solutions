...
description: Problem Description and Solution for Largest 1-Bordered Square
sidebar_label: 1139. Largest 1-Bordered Square
sidebar_position: 1139
---

# [1139. Largest 1-Bordered Square](https://leetcode.com/problems/largest-1-bordered-square/)

```py title=largest-1-bordered-square.py
class Solution:
