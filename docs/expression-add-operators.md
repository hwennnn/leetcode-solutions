...
description: Problem Description and Solution for Expression Add Operators
sidebar_label: 282. Expression Add Operators
sidebar_position: 282
---

# [282. Expression Add Operators](https://leetcode.com/problems/expression-add-operators/)

```py title=expression-add-operators.py
class Solution:
