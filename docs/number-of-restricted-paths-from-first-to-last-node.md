...
description: Problem Description and Solution for Number of Restricted Paths From First to Last Node
sidebar_label: 1786. Number of Restricted Paths From First to Last Node
sidebar_position: 1786
---
...
```py title=number-of-restricted-paths-from-first-to-last-node.py
class Solution:
