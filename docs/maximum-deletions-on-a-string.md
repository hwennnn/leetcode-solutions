...
description: Problem Description and Solution for Maximum Deletions on a String
sidebar_label: 2430. Maximum Deletions on a String
sidebar_position: 2430
---

# [2430. Maximum Deletions on a String](https://leetcode.com/problems/maximum-deletions-on-a-string/)

```py title=maximum-deletions-on-a-string.py
class Hashes:
