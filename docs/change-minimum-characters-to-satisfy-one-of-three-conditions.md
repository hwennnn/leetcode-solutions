...
description: Problem Description and Solution for Change Minimum Characters to Satisfy One of Three Conditions
sidebar_label: 1737. Change Minimum Characters to Satisfy One of Three Conditions
sidebar_position: 1737
---
...
```py title=change-minimum-characters-to-satisfy-one-of-three-conditions.py
class Solution:
