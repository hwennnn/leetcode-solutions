...
description: Problem Description and Solution for Minimum Cost For Tickets
sidebar_label: 983. Minimum Cost For Tickets
sidebar_position: 983
---

# [983. Minimum Cost For Tickets](https://leetcode.com/problems/minimum-cost-for-tickets/)

```py title=minimum-cost-for-tickets.py
class Solution:
