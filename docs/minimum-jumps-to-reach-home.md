...
description: Problem Description and Solution for Minimum Jumps to Reach Home
sidebar_label: 1654. Minimum Jumps to Reach Home
sidebar_position: 1654
---

# [1654. Minimum Jumps to Reach Home](https://leetcode.com/problems/minimum-jumps-to-reach-home/)

```py title=minimum-jumps-to-reach-home.py
class Solution:
