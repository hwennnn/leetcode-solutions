...
description: Problem Description and Solution for Minimum Area Rectangle II
sidebar_label: 963. Minimum Area Rectangle II
sidebar_position: 963
---

# [963. Minimum Area Rectangle II](https://leetcode.com/problems/minimum-area-rectangle-ii/)

```py title=minimum-area-rectangle-ii.py
class Solution:
