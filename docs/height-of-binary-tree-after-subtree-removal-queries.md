...
description: Problem Description and Solution for Height of Binary Tree After Subtree Removal Queries
sidebar_label: 2458. Height of Binary Tree After Subtree Removal Queries
...
```py title=height-of-binary-tree-after-subtree-removal-queries.py
