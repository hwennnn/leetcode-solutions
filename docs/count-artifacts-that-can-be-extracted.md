...
description: Problem Description and Solution for Count Artifacts That Can Be Extracted
sidebar_label: 2201. Count Artifacts That Can Be Extracted
...
```py title=count-artifacts-that-can-be-extracted.py
class Solution:
