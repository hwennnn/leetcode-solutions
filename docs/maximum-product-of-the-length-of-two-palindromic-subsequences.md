...
description: Problem Description and Solution for Maximum Product of the Length of Two Palindromic Subsequences
...
```py title=maximum-product-of-the-length-of-two-palindromic-subsequences.py
class Solution:
