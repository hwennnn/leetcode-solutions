...
description: Problem Description and Solution for Maximum Product of Splitted Binary Tree
sidebar_label: 1339. Maximum Product of Splitted Binary Tree
sidebar_position: 1339
---

# [1339. Maximum Product of Splitted Binary Tree](https://leetcode.com/problems/maximum-product-of-splitted-binary-tree/)

```py title=maximum-product-of-splitted-binary-tree.py
