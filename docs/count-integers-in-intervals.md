...
description: Problem Description and Solution for Count Integers in Intervals
sidebar_label: 2276. Count Integers in Intervals
sidebar_position: 2276
---

# [2276. Count Integers in Intervals](https://leetcode.com/problems/count-integers-in-intervals/)

```py title=count-integers-in-intervals.py
