...
description: Problem Description and Solution for Escape the Spreading Fire
sidebar_label: 2258. Escape the Spreading Fire
sidebar_position: 2258
---

# [2258. Escape the Spreading Fire](https://leetcode.com/problems/escape-the-spreading-fire/)

```py title=escape-the-spreading-fire.py
class Solution:
