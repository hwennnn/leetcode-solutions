...
description: Problem Description and Solution for Longest Increasing Subsequence II
sidebar_label: 2407. Longest Increasing Subsequence II
...
```py title=longest-increasing-subsequence-ii.py
class SegmentTree:
