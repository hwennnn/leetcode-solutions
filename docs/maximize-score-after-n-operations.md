...
description: Problem Description and Solution for Maximize Score After N Operations
sidebar_label: 1799. Maximize Score After N Operations
sidebar_position: 1799
---

# [1799. Maximize Score After N Operations](https://leetcode.com/problems/maximize-score-after-n-operations/)

```py title=maximize-score-after-n-operations.py
class Solution:
