...
description: Problem Description and Solution for Minimum White Tiles After Covering With Carpets
sidebar_label: 2209. Minimum White Tiles After Covering With Carpets
sidebar_position: 2209
---
...
```py title=minimum-white-tiles-after-covering-with-carpets.py
class Solution:
