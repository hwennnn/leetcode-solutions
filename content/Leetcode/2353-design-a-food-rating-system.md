...
class FoodRatings:
    ...
    def __init__(self, foods: List[str], cuisines: List[str], ratings: List[int]):
        ...
        for food, cuisine, rating in zip(foods, cuisines, ratings):
            ...
            heappush(self.heap[cuisine], (-rating, food))

    def changeRating(self, food: str, newRating: int) -> None:
        self.mp[food][1] = newRating
        cuisine = self.mp[food][0]
        heappush(self.heap[cuisine], (-newRating, food))

    def highestRated(self, cuisine: str) -> str:
        # lazy remove invalid data from the heap
        while self.heap[cuisine] and -self.heap[cuisine][0][0] != self.mp[self.heap[cuisine][0][1]][1]:
